...
const AppShell: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top_left,_#c7f9ff,_transparent_40%),radial-gradient(circle_at_bottom_right,_#ffeab6,_transparent_45%),#f8fafc] text-slate-900 pb-20 lg:pb-0 overflow-x-hidden">
          ...
          {navItems.map((item) => {
            ...
            return (
              <NavLink
                ...
                className={({ isActive }) =>
                  [
                    'flex flex-col sm:flex-row items-center justify-center gap-1 sm:gap-2 rounded-xl px-2 py-2.5 text-[11px] sm:text-xs font-bold transition-all',
                    isActive
