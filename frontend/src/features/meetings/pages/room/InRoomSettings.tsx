        ...
        <div className="space-y-10 font-sans">
          ...
          <div className="space-y-7">
            <div className="space-y-2">
              <label className="text-[13px] font-bold text-slate-200 font-premium-ink px-0.5">
                {t("meeting.title")}
              </label>
              <input
                type="text"
          ...
          <div className="space-y-8">
            <div className="space-y-2">
              <div className="flex items-center gap-2 mb-3">
                <span className="text-[13px] font-bold text-slate-200 font-premium-ink px-0.5">
                  {t("meeting.access_control")}
                </span>
              </div>
