...
const QuestionDetailModal: React.FC<QuestionDetailModalProps> = ({ 
  ...
  return (
    <BaseModal
      ...
      onClose={onClose}
      title={t('meeting.discussion_details') || 'Chi tiết hỏi đáp'}
      subtitle={t('meeting.view_all_responses') || 'Xem tất cả câu trả lời từ mọi người'}
            ...
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-sm font-bold text-slate-200">
                {question.askedByUserId === userId 
                  ? t('common.you') || 'Bạn'
                  : getUserDisplayName(question.askedByUser, question.askedByParticipant)
                }
              </span>
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-[14px] font-bold text-white">
                          {ans.answeredByUserId === userId 
                            ? t('common.you') || 'Bạn'
                            : getUserDisplayName(ans.answeredByUser, ans.answeredByParticipant)
                          }
                        </span>
