...
import SettingToggle from "./general/SettingToggle";
import EmailTagInput from "./general/EmailTagInput";
import { AttachmentManager } from "./permissions/AttachmentManager";
    ...
    >
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full border-b-2 border-slate-200 bg-transparent py-2 pl-10 text-base font-medium focus:border-cyan-500 focus:outline-none transition-all ${
                    !canEdit || isOngoing ? "cursor-default opacity-60" : ""
                  }`}
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 gap-3">
              <button
                type="button"
                onClick={() =>
                  canEdit && setFormData({ ...formData, accessType: "public" })
                }
              ...
              <button
                type="button"
                onClick={() =>
                  canEdit && setFormData({ ...formData, accessType: "invite_only" })
                }
                className={`p-4 rounded-xl border-2 transition-all flex items-center gap-4 ${
      ...
      <section className="space-y-8 pt-10 border-t border-slate-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="p-4 rounded-2xl bg-white/40 border border-slate-200 flex items-center justify-between animate-none">
