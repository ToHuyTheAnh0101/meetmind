...
| 4 | **Hỏi & Đáp** (Q&A / Discussion) | ✅ Hoàn thành | ✅ Hoàn thành | [qa.md](file:///home/theanh/meetmind/docs/qa.md) | Host đặt câu hỏi, phân quyền hiển thị câu trả lời (Filter), LiveKit Data Channel sync. |
| 5 | **Bình chọn** (Polls) | ✅ Hoàn thành | ✅ Hoàn thành | [polls.md](file:///home/theanh/meetmind/docs/polls.md) | Bình chọn Đơn/Đa lựa chọn, biểu đồ kết quả (%) thời gian thực, Khóa bình chọn. |
...
| 7 | **Hỏi đáp AI Chatbot** (AI Chatbot Q&A) | ✅ Hoàn thành | ✅ Hoàn thành | [meetings.md](file:///home/theanh/meetmind/docs/meetings.md) | RAG Vector (`pgvector`), Streaming SSE, Tích hợp Slide Capture hiển thị hình ảnh tự động. |
