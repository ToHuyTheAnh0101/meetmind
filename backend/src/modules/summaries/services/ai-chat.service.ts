...
export class AiChatService {
  ...
  async chatWithAI(
    ...
    // 4. Tìm ảnh màn hình liên quan bằng hybrid retrieval
    const relevantCaptures = await this.meetingsService.findRelevantCaptures(
      meetingId,
      relevantChunks,
      questionEmbedding,
    );
