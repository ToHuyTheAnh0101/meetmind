...
Reference full template: `/home/theanh/meetmind/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/theanh/meetmind/.claude/get-shit-done/templates/state.md`.
